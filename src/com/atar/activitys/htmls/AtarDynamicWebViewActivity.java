...
import com.atar.activitys.AtarRefreshActivity;
...
public class AtarDynamicWebViewActivity extends AtarRefreshActivity<PullToRefreshWebView, WebView> {
	...
	protected void initValue() {
		...
		optionsJson = DynamicHtmlUtils.getInitValue(this, this, getPullView(), options, mode, url, getCurrentSkinType(), mImplOnTouchChanceTextSizeListener);
		/* 向html传入初始参数 end */
	}
	...
	*/
	 ...
	 */
	public static void startAtarDynamicWebViewActivity(Context context, String url, String strTitle, String top_right_img_url, String top_right_txt, String options, String mode,
			boolean isFlagActivityNewTask) {
		Intent intent = new Intent(context, AtarDynamicWebViewActivity.class);
	...
	public void ChangeSkin(int skinType) {
		...
		SkinUtils.setBackgroundColor(this, R.string.item_white_black_bg, skinType, getRefreshView(), getPullView());
		try {
			if (isWebViewLoadSuccess) {
