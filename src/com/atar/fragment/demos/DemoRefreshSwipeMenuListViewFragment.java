 ...
 *****************************************************************************************************************************************************************************
 */
public class DemoRefreshSwipeMenuListViewFragment extends AtarRefreshSwipeMenuListViewFragment {
	...
	public void create(SwipeMenu menu) {
		...
		// set item width
		openItem.setWidth((int) ScreenUtils.dpToPx(getActivity(), 90));
		// set item title
		...
		// set item width
		deleteItem.setWidth((int) ScreenUtils.dpToPx(getActivity(), 90));
		// set a icon
